#!/bin/bash
# Test-only rerun of the KLAX 4T scorer, to pick up the corrected NLL
...
# score head is already trained and saved by eval_scorer_klax_4T.sh, this
...
#
# Needs the same decoder overrides as eval_scorer_klax_4T.sh (enable_score_head/
...
#   /gpfs/scratch/exy064/ljx/Risk-Assessment/AmeliaTF_main_two_phases_4T/out/klax2/per_mode_scorer_hard.pt

#SBATCH --job-name=amelia_eval_scorer_klax_4T_test
#SBATCH --output=eval_scorer_klax_4T_test_%j.out
#SBATCH --error=eval_scorer_klax_4T_test_%j.err
