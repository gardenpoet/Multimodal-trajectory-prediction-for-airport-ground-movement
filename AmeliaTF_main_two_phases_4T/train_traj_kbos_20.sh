...
#SBATCH --output=traj_kbos_20_%j.out
#SBATCH --error=traj_kbos_20_%j.err
...
# Requires train_mode_kbos_20.sh to have completed first (produces the fixed
# mode checkpoint this run reuses via skip_mode_training=true). Submit 3x:
#   sbatch --export=ALL,NUM_FUTURES=1 train_traj_kbos_20.sh
#   sbatch --export=ALL,NUM_FUTURES=2 train_traj_kbos_20.sh
#   sbatch --export=ALL,NUM_FUTURES=4 train_traj_kbos_20.sh
