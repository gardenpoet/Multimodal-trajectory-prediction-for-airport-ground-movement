#!/bin/bash
# Test-only rerun of the KBOS 2T scorer, to pick up the corrected NLL
...
# score head is already trained and saved by eval_scorer_kbos_2T.sh, this
...
#
# Needs the same decoder overrides as eval_scorer_kbos_2T.sh (enable_score_head/
...
#   /gpfs/scratch/exy064/ljx/Risk-Assessment/AmeliaTF_main_two_phases_4T/out/kbos2/per_mode_scorer_hard_2T.pt

#SBATCH --job-name=amelia_eval_scorer_kbos_2T_test
#SBATCH --output=eval_scorer_kbos_2T_test_%j.out
#SBATCH --error=eval_scorer_kbos_2T_test_%j.err
