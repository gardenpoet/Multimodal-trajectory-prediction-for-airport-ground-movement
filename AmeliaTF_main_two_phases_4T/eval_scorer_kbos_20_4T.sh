#!/bin/bash
# Trains a learned trajectory-selection scorer for KBOS's 20s-horizon 4T
...
#
# Mirrors eval_scorer_kbos_20_2T.sh, but points at the 4T trajectory
...
#SBATCH --job-name=amelia_eval_scorer_kbos20_4T
#SBATCH --output=eval_scorer_kbos_20_4T_%j.out
#SBATCH --error=eval_scorer_kbos_20_4T_%j.err
