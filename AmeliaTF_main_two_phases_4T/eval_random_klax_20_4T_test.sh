#!/bin/bash
# Random-selection baseline for KLAX H20 4T. See eval_random_kmsy_2T_test.sh
# for the full rationale.

#SBATCH --job-name=amelia_eval_random_klax20_4T_test
#SBATCH --output=eval_random_klax_20_4T_test_%j.out
#SBATCH --error=eval_random_klax_20_4T_test_%j.err
