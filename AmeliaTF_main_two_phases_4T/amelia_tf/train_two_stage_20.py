...
class TwoStageTrainer:
    ...
    def train_trajectory_model(self, datamodule: LightningDataModule) -> None:
        """
        Stage 2: Train the trajectory prediction model.
    
        Mode conditioning comes from the frozen Stage 1 model at every step.
        No teacher forcing.
        """
        log.info("=" * 70)
        ...
        # -- Instantiate Stage 2 with frozen mode_net ----------
...
@hydra.main(version_base="1.3", config_path="../configs", config_name="train_two_stage_20")
