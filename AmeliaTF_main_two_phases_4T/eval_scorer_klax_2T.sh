#!/bin/bash
# Trains a learned trajectory-selection scorer for KLAX's 2T (num_hypotheses=2,
...
#
# Mirrors eval_scorer_klax_4T.sh, but points at the 2T trajectory checkpoint.
...
# mode_ckpt_path is overridden the same way as eval_scorer_klax_4T.sh (mode
...
#SBATCH --job-name=amelia_eval_scorer_klax_2T
#SBATCH --output=eval_scorer_klax_2T_%j.out
#SBATCH --error=eval_scorer_klax_2T_%j.err
