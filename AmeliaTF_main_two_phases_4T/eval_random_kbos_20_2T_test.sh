#!/bin/bash
# Random-selection baseline for KBOS H20 2T. See eval_random_kmsy_2T_test.sh
# for the full rationale.

#SBATCH --job-name=amelia_eval_random_kbos20_2T_test
#SBATCH --output=eval_random_kbos_20_2T_test_%j.out
#SBATCH --error=eval_random_kbos_20_2T_test_%j.err
