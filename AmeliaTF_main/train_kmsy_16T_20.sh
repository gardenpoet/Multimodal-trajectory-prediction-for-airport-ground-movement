#!/bin/bash
# Amelia num_futures ablation: retrain KMSY H20 with 16 raw candidate
...
#SBATCH --job-name=amelia_train_kmsy_16T_20
#SBATCH --output=kmsy_16T_20.out
#SBATCH --error=kmsy_16T_20.err
