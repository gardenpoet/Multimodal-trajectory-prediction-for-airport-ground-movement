#!/bin/bash
# Amelia num_futures ablation: retrain KLAX H20 with 16 raw candidate
...
#SBATCH --job-name=amelia_train_klax_16T_20
#SBATCH --output=klax_16T_20.out
#SBATCH --error=klax_16T_20.err
