...
# whether the ground-truth closest-approach agent in each KLAX case-study
...
# fit; KLAX's highest target batch_idx is 4032, the largest of the three).
#
# Run from the repo root:
#   sbatch risk_assessment/run_check_agent_types_klax.sh
