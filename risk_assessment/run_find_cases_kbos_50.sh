...
#   sbatch --export=ALL,LIMIT=5 risk_assessment/run_find_cases_kbos_50.sh

#SBATCH --job-name=amelia_risk_kbos_50
#SBATCH --output=risk_kbos_50_%j.out
#SBATCH --error=risk_kbos_50_%j.err
...
OUT_CSV="/gpfs/scratch/exy064/ljx/Risk-Assessment/out/risk_assessment/kbos_50_cases.csv"
