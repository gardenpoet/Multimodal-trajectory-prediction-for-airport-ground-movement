...
#SBATCH --output=stgcnn_kmsy_eval.out
#SBATCH --error=stgcnn_kmsy_eval.err
...
# log: grep "Best ckpt path:" stgcnn_kmsy.out
python -m amelia_tf.train_stgcnn_kmsy train=false \
