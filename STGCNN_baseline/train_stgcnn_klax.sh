...
#SBATCH --output=stgcnn_klax_eval.out
#SBATCH --error=stgcnn_klax_eval.err
...
# log: grep "Best ckpt path:" stgcnn_klax.out
python -m amelia_tf.train_stgcnn_klax train=false \
